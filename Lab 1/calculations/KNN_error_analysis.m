...
% Confusion matrix
[TA, FA] = get_error(n_a, NN(5, samples_a, samples_b, test_a), @(d) d < 0);
[TB, FB] = get_error(n_b, NN(5, samples_a, samples_b, test_b), @(d) d > 0);
...
NN_cd_sample_c = NN(5, samples_c, samples_d, test_c);
NN_de_sample_c = NN(5, samples_d, samples_e, test_c);
NN_ec_sample_c = NN(5, samples_e, samples_c, test_c);


NN_cd_sample_d = NN(5, samples_c, samples_d, test_d);
NN_de_sample_d = NN(5, samples_d, samples_e, test_d);
NN_ec_sample_d = NN(5, samples_e, samples_c, test_d);


NN_cd_sample_e = NN(5, samples_c, samples_d, test_e);
NN_de_sample_e = NN(5, samples_d, samples_e, test_e);
NN_ec_sample_e = NN(5, samples_e, samples_c, test_e);
